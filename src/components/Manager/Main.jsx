...
function Main() {
  ...
  return (
    <>
      <div className='container shadow-sm p-3 mt-4 bg-white rounded worker-active-inactive'>
        <div className='btn btn-success active-worker'>Active Worker's : {totalActiveWorkers}</div>
        <div className='btn btn-danger inactive-worker'>Inactive Worker's : {totalInactiveWorkers}</div>
        <div className='btn btn-success processing-diamond'>Processing Diamonds: {totalDiamonds}</div>
      </div>
